...
L'anno 2021 è usato perché, tra gli anni controllati, è il più recente
...
più bassa. I box però si sovrappongono in tutte le variabili: nessun
...
- **Accuratezza:** quota totale di regioni classificate correttamente.
- **Sensitività (macro):** per ogni classe misura quante regioni vere di quella classe sono riconosciute; poi fa la media tra le tre classi.
- **Specificità (macro):** per ogni classe misura quante regioni non appartenenti a quella classe sono escluse correttamente; poi fa la media tra le tre classi.
